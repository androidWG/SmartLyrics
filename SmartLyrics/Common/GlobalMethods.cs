...
namespace SmartLyrics
{
    class Globals
    {
        ...
        public static string databaseLocation = "/.lyricsdatabse";
        ...
        public static async Task CheckAndCreateDatabaseFile()
        {
            if (File.Exists(Path.Combine(path, databaseLocation)))
            {
                Log.WriteLine(LogPriority.Verbose, "SmartLyrics", "Globals.cs: Databse file already exists!");
            }
            else
            {
                
                Log.WriteLine(LogPriority.Verbose, "SmartLyrics", "Globals.cs: Databse file doesn't exist, creating...");
            }
        }
    }
}